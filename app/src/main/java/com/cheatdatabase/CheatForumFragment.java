...
public class CheatForumFragment extends Fragment implements OnClickListener, Serializable {
    ...
    /**
     * Fill the table in a parsed ForumPost
     */
    ...
    private class GetForumPostsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                Log.e("GetForumPostsTask ERR", e.getLocalizedMessage());
            }
