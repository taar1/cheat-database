...
//    }
    ...
    public FavoriteCheatModel(int gameId, String gameName, int cheatId, String cheatTitle, String cheatText, int systemId, String systemName, int languageId, int gameCount, Boolean isWalkthrough, int memberId) {
        this.gameId = gameId;
