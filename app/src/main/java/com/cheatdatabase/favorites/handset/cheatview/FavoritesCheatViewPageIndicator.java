 ...
 * 
 */
public class FavoritesCheatViewPageIndicator extends FragmentActivity implements ReportCheatDialogListener, RateCheatDialogListener, UndoBarController.UndoListener, AdListener {
...
//			mIndicator.setSelectedColor(color.page_indicator);
	...
	private class ReportCheatTask extends AsyncTask<String, Boolean, Boolean> {
		...
		protected void onPostExecute(Boolean success) {
			if (success) {
				Toast.makeText(FavoritesCheatViewPageIndicator.this, R.string.thanks_for_reporting, Toast.LENGTH_LONG).show();
			} else {
