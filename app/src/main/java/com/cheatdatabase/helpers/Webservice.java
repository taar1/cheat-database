...
public class Webservice {
	 ...
	 * 
	 * @param postURL
	 *            URL der aufzurufenden Website
	 * @param alParams
	 *            ArrayList mit String[]-Arrays (0 = Parameter-Name, 1 =
	 *            Parameter-Wert)
	 * @return
	 */
	 ...
	 * @param query
	 * @param cheatIds
	 *            (z.b. 34,52345,234,123)
	 * @param gameIds
	 *            (z.b. 555,400,2500)
	 * @param systemIds
	 *            (z.b. 2,16,4)
	 * @param searchInTitlesToo
	 *            (0 = Titel nicht durchsuchen, 1 = Titel durchsuchen)
	 * @return Cheat[]
